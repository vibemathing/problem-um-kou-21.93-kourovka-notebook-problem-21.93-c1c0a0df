...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.93"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-v1",
      "problem_contract_sha256": "7c899efeb48c5c380760c4e29a94afe9f382183501e629f158f78f5598756473",
      "problem_id": "problem:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df",
      "route_id": "route:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-source-fidelity-01",
      "graph_id": "graph:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be a group and let $k\\geqslant 2$. Let $H_1,\\ldots,H_k$ be subgroups of $G$, and $g_1,\\ldots,g_k$ elements of $G$ such that the cosets $g_1H_1,\\ldots,g_kH_k$ form a partition of $G$. Is it true that $|G:H_i|=|G:H_j|$ for some $i\\ne j$?"
          },
          "statement_sha256": "9cfb43916aa1ccc9cb04e62e94ac78a46f2d117a241253943b737d64e2b36175"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-root",
      "route_id": "route:um-kou-21.93-kourovka-notebook-problem-21.93-c1c0a0df-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.93-466f55d6ca76",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.93"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
